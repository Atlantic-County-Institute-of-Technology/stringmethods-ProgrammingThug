...
public class Main
{
    public static void main(String[] args)
    {
        ...
        //Reverses order of the user's name
        String reverse = "";
        ...
        //Capitalizes the reversed name
        String revCaps = "";
        int ascii = 0;
        for(int i = 0; i < (name.length()); i++)
        {
            ascii = reverse.charAt(i);
            if (ascii != 32) && (ascii > 97)
            {
                ascii = ascii - 32;
            }
            revCaps = revCaps + (char) ascii;
        }
        System.out.println(revCaps);
        ...
        //Converts name to ASCII
        String asciiText = "";
        ascii = 0;
        for(int i = 0; i < (name.length()); i++)
        {
            asciiText = asciiText + (int) name.charAt(i);
        }
